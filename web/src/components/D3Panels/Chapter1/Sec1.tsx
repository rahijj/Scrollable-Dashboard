...
const HorzBarGraph: React.FC<P> = ({ width, height, cardInd, isVisible, section, headHeight }) => {
    ...
    return (
        <div id="SecTemp1" className="section" style={{ width: `${width}`, height: `${(height + headHeight) * 4}px` }}>
            ...
            <div id="vis" style={{ height: height }}>
                <svg id="SecTemp1SVG" width={width} height={height} style={{ backgroundColor: Colors[cardInd] }}></svg>
            </div>
        </div>
    );
};
